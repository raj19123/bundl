...
class __TwigTemplate_4db714ef196cc2f8c2116949d3c155cf2f4e4692a1dd8e4aa391eddea6c57960 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/home/bundolih/public_html/phpmyadmin/templates/database/export/index.twig");
    }
}
