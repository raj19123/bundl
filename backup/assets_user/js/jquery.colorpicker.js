    ...
    this.parts = {
      ...
      map: function (inst) {
        var that = this,
          ...
          _mousedown, _mouseup, _mousemove, _keydown, _html, _touchmove, _touchstart, _touchend;
        ...
        _touchmove = function (event) {
          ...
          //var eventPageX = event.originalEvent.touches[0].pageX;
          //var eventPageY = event.originalEvent.touches[0].pageY;

          var eventPageX = event.touches[0].pageX;
          var eventPageY = event.touches[0].pageY;

          if (eventPageX === that.x && eventPageY === that.y) {
            return;
          }
          that.x = eventPageX;
          that.y = eventPageY;
          ...
          var offset = layers.p.offset(),
            x = eventPageX - offset.left,
            y = eventPageY - offset.top;
        ...
        this.init = function () {
          ...
          //touch events
          part.on('touchmove', _touchmove);
          //part.on('touchstart', _touchstart);
          //part.on('touchend', _touchend);
          //part.on('touchcancel', _touchend);
          //part.on('touchleave', _touchend);
