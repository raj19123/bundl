...
var customScript = {
  ...
  touchspin: function(){
    ...
    $('.logo_lang_single').click(function(event){
      $( "ul.logo-lang-class li:eq(0)" ).find('div').text(3840);
      $( "ul.logo-lang-class li:eq(1)" ).find('div').text(20);
      $(this).closest("form").find("input[name='price']").val(3840);
      $(this).closest("form").find("input[name='init_price']").val(3840);
      $(this).closest("form").find("input[name='time']").val(20);
      $(this).closest("form").find("input[name='init_time']").val(20);
    });

    $('.logo_lang_both').click(function(event){
      $( "ul.logo-lang-class li:eq(0)" ).find('div').text(5840);
      $( "ul.logo-lang-class li:eq(1)" ).find('div').text(30);
      $(this).closest("form").find("input[name='price']").val(5840);
      $(this).closest("form").find("input[name='init_price']").val(5840);
