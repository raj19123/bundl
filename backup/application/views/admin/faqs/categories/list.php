...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>FAQs Categories List <small></small></h2>
        <div class="nav navbar-right">
          <a href="<?= base_url('admin/faqs/categories/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</a>
        </div>
            ...
            if( (isset($list)) && !(empty($list)) ){
              ...
              foreach ($list as $key => $design) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?= base_url('admin/faqs/categories/edit/') . $design['id']; ?>" 
                      class="btn btn-primary btn-xs"
                    ><i class="fa fa-edit"></i> Edit</a>

                    <!-- <a href="<?php //base_url('admin/faqs/categories/delete/') . $design['id']; ?>" 
                    ...
                    <button onclick="deleteRecord(this)" 
                        ...
                        data-id="<?= $design['id']; ?>" 
                        data-url="<?= base_url('admin/faqs/categories/delete'); ?>" 
                        data-images="yes"
