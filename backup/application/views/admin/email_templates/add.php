      ...
      <div class="x_content">
        ...
        <form method="post" 
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="email_english" name="email_body_english" class="form-control col-md-7 col-xs-12 parsley-success"><?php if(isset($edit)){ echo $edit['email_body_english'];} ?></textarea>
              <ul class="parsley-errors-list"></ul>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="email_arabic" name="email_body_arabic" class="form-control col-md-7 col-xs-12 parsley-success" dir="rtl"><?php if(isset($edit)){ echo $edit['email_body_arabic'];} ?></textarea>
              <ul class="parsley-errors-list"></ul>
            </div>
          </div>
