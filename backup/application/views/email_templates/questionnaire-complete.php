...
<body>
    <section class="order-section" style="padding: 50px 0px 50px 0px;">
        ...
        font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('questionnaire_completed'); ?></h2>
            <p style="padding: 30px 0px 30px 0px; font-style: italic; font-size: 25px;     text-align: center;
        color: black; margin: 0; font-family: 'Open Sans', sans-serif;     line-height: 40px;"><?= $notification['email_body_'.$language] ?> </p>
            <div class="order-details" style="text-align: center; padding-bottom: 30px;<?= ($language != 'english')?'direction: rtl':''; ?>">
