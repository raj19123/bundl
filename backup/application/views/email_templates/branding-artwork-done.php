...
<head>
    <title><?= $this->lang->line('branding_artwork_email'); ?></title>
...
<body>
    <section class="order-section" style="padding: 50px 0px 50px 0px;">
        <div class="container" style="max-width: 800px; margin: auto">
            <h2 style="text-align: center; border-bottom: 2px solid rgba(0, 0, 0, 0.5); padding-bottom: 18px; margin: 0px; font-size: 32px;
        font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('branding_artwork_done'); ?></h2>
             <p style="text-align: center; padding: 30px 0px 10px 0px;<?= ($language != "english")?'dir:rtl;':''; ?>" ><strong style="padding: 30px 0px 65px 0px; font-style: italic; font-size: 22px;     text-align: center; color: black; margin: 0; font-family: 'Open Sans', sans-serif;     line-height: 40px;"><span style="font-size: 22px; font-family: 'Open Sans', sans-serif; font-weight: bold; border-bottom: 1px solid black; line-height: 1;"><?= $this->lang->line('order_name'); ?>:</span><i style="font-size:22px; font-family: 'Open Sans', sans-serif; letter-spacing: 0px;"> {order_name}</i></strong></p>
            <p style="padding: 10px 0px 70px 0px; font-style: italic; font-size: 22px;     text-align: center;
        color: black; margin: 0; font-family: 'Open Sans', sans-serif;     line-height: 40px;"><?= $notification['email_body_'.$language] ?>
        <br>
            <strong><?= $this->lang->line('branding_artwork_files_availability') ?></strong>
        </p>
            
            <div style="text-align: center; padding-bottom: 42px;width: 87%; margin: auto; border-bottom: 2px solid rgba(0, 0, 0, 0.5);">
                <?php if ($language == 'english') : ?>
                    <a href="{btn_link}" style=" border: 1px solid black; text-decoration: none; padding: 1px 35px; color: black; letter-spacing: 5px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('go_to_dashboard'); ?></a>
                <?php else: ?>
                    <a href="{btn_link}" style=" border: 1px solid black; text-decoration: none; padding: 1px 35px; color: black; letter-spacing: 0px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('go_to_dashboard'); ?></a>
            ...
            <div style="text-align: center;">
                <h3 style="font-size: 22px; font-family: 'Open Sans', sans-serif; text-align: center;  padding-bottom: 10px; margin-bottom: 55px; margin-top: 50px; font-weight: 600; display: inline-block; text-align: center; border-bottom: 2px solid rgba(0, 0, 0, 0.5);"><?= $this->lang->line('what_the_next'); ?></h3>
            </div>
    ...
    <footer style="padding: 0px 0px 150px 0px;">
        <div class="container" style="max-width: 800px; margin: auto;">
            <h2 style="text-align: center; border-bottom: 1px solid rgba(0, 0, 0, 0.5); padding-bottom: 25px; margin: 0px; font-size: 28px;
