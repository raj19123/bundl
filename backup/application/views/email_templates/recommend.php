...
<body>
    <section class="order-section" style="padding: 50px 0px 70px 0px;">
        ...
        font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('recommended'); ?>
            </h2>
            <p style="padding: 30px 0px 0px 0px; font-style: italic; font-size: 25px; text-align: center;
            color: black; margin: 0; font-family: 'Open Sans', sans-serif; line-height: 45px;">
            <?= $this->lang->line('hello'); ?> {name},
            </p>
            <p style="padding: 30px 0px 0px 0px; font-style: italic; font-size: 25px; text-align: center;
            color: black; margin: 0; font-family: 'Open Sans', sans-serif; line-height: 45px;"><?= $notification['email_body_'.$language]; ?>
            </p>
            <p style="padding: 30px 0px 40px 0px; font-style: italic; font-size: 25px;     text-align: center; color: black; margin: 0; font-family: 'Open Sans', sans-serif; line-height: 45px;"> <?= $this->lang->line('friend_message_key'); ?>: {friend_message}
            </p>
            <div style="text-align: center;">
                <?php if ($language == 'english') : ?>
                    <a href="{link_activation}" style=" border: 1px solid black; text-decoration: none; color: black; padding: 1px 53px; letter-spacing: 5px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('create_your_account'); ?></a>
                <?php else: ?>
                    <a href="{link_activation}" style=" border: 1px solid black; text-decoration: none; color: black; padding: 1px 53px; letter-spacing: 0px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('create_your_account'); ?></a>
                <?php endif; ?>
            </div>
