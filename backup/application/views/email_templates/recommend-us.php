...
<body>
    <section class="order-section" style="padding: 50px 0px 70px 0px;">
        ...
        font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('footer_recomend_li'); ?>
            </h2>
            ...
            <div style="text-align: center;">
                <?php if ($language == 'english') : ?>
                    <a href="{link_activation}" style=" border: 1px solid black; text-decoration: none; color: black; padding: 1px 53px; letter-spacing: 5px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('footer_recomend_li'); ?></a>
                <?php else: ?>
                    <a href="{link_activation}" style=" border: 1px solid black; text-decoration: none; color: black; padding: 1px 53px; letter-spacing: 0px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('footer_recomend_li'); ?></a>
                <?php endif; ?>
            </div>
