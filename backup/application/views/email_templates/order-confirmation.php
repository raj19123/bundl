...
<body>
    <section class="order-section" style="padding: 50px 0px 50px 0px;">
        ...
        font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('order_confirmation'); ?></h2>
        ...
        color: black; margin: 0; font-family: 'Open Sans', sans-serif;"><?= $notification['email_body_'.$language] ?> </p>
            <div class="order-details" style="text-align: center; padding-bottom: 50px; <?= ($language != "english")?'direction: rtl;':'';  ?> ">
                <p><span style="font-size: 22px; font-family: 'Open Sans', sans-serif; font-weight: bold; border-bottom: 1px solid black; line-height: 1;"><?= $this->lang->line('order_name'); ?>:</span><i style="font-size:22px; font-family: 'Open Sans', sans-serif; letter-spacing: 0px;"> {order_name}</i></p>
                <p><span style="font-size: 22px; font-family: 'Open Sans', sans-serif; font-weight: bold; border-bottom: 1px solid black; line-height: 1;"><?= $this->lang->line('order_number'); ?>:</span><i style="font-size:22px; font-family: 'Open Sans', sans-serif; letter-spacing: 0px;"> {order_id}</i></p>
            ...
            <?php if (isset($order_summery)) { ?>
                <div class="order-summery" <?= ($language != "english")?'style="direction:rtl;"':''; ?>>
                    <h3 style="color: #6ec3bd; font-size: 32px; font-family: 'Open Sans', sans-serif; font-weight: 600; font-weight: 500; letter-spacing: -1px;"><?= $this->lang->line('order_summery'); ?>:</h3>
                    <table style="width: 100%; padding: 0px 0px 60px 0px; border-bottom: 1px solid black;" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <th style="text-align: <?=  ($language != "english")?'right;':'left;'; ?>"><span style="border-bottom: 1px solid black; text-align: left;font-size: 22px; font-family: 'Open Sans', sans-serif;"><?= $package_name ?>:</span></th>
                            <?php $add_ons = false;
                            foreach ($order_summery as $key => $value) { 
                            ...
                            if ($add_ons == true) { ?>
                                <th style="text-align: <?=  ($language != "english")?'right;':'left;'; ?>"><span style=" border-bottom: 1px solid black; text-align: left;font-size: 22px; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('add_ons'); ?>:</span></th>
                            <?php } ?>
                        </tr>
                        <tr>
                            <td style="    padding: 10px 0px; font-family: 'Open Sans', sans-serif; font-size: 20px; vertical-align: initial;">
                                <ul style="list-style: none; padding: 0; margin-bottom: 0;">
                                    <?php foreach ($order_summery as $key => $value) { 
                                        if (in_array($value['item_type'], ['logo', 'design'])) {
                                            ...
                                            ?>
                                        <li style="font-family: 'Open Sans', sans-serif; font-size: 20px; margin-bottom: 12px; color: #000;"><?= $item_name; ?></li>
                                    <?php } } ?>
                                </ul> 
                            </td>
                            <td style="font-family: 'Open Sans', sans-serif; font-size: 20px; vertical-align: initial;">
                                <ul style="list-style: none; padding: 0; margin-bottom: 0;">
                                    <?php foreach ($order_summery as $key => $value) { 
                                        if (in_array('custom_addon', array_column($order_summery, 'item_type'))) {
                                            if (in_array($value['item_type'], ['custom_addon'])) { ?>
                                                <li style="font-family: 'Open Sans', sans-serif; font-size: 20px; margin-bottom: 12px; color: #000;"><?= $value['name_'.$language]; ?></li>
                                        <?php } } else if (in_array($value['item_type'], ['addon', 'custom_addon'])) {
                                            ?>
                                        <li style="font-family: 'Open Sans', sans-serif; font-size: 20px; margin-bottom: 12px; color: #000;"><?= $value['name_'.$language]; ?></li>
                                    <?php } } ?>
                                </ul>
    ...
    <footer style="padding: 0px 0px 150px 0px;">
        <div class="container" style="max-width: 800px; margin: auto;">
            ...
            <!-- <form style="text-align: center; padding-top: 0px;">
                <h3 style="font-size: 30px; font-weight: 700; font-family: 'Open Sans', sans-serif; color: #6ec3bd; margin-bottom: 0px;">SIGN UP FOR OUR NEW LETTER</h3>
                <div class="wrap" style="display: flex; justify-content: left;align-items: baseline; width: 56%;margin: auto; padding-top: 15px; border-bottom: 2px solid black;">
                    ...
                    <input type="text" value="example@mail.com" style="width: 50%; color: #ccc; font-size: 16px; background: none; border: none; box-shadow: none; outline: none;">
                </div>
                <button style="font-style: normal; font-family: 'Open Sans', sans-serif; border-top: 7px solid black; border-right: 10px solid black; width: 30%; letter-spacing: 5px;font-weight: 600;font-size: 14px;
                background: none; margin-top: 33px;">SIGN UP</button>
            </form> -->
        </div>
    </footer>
</body>