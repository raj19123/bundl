...
<body>
    <section class="order-section" style="padding: 50px 0px 70px 0px;">
        ...
        font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('login_fordot_pass_link'); ?></h2>
            <p style="padding: 30px 0px 70px 0px; font-style: italic; font-size: 25px;     text-align: center;
        color: black; margin: 0; font-family: 'Open Sans', sans-serif;     line-height: 40px;"><?= $notification['email_body_'.$language] ?> </p>
            <div style="text-align: center;">
                <?php if ($language == 'english') : ?>
                    <a href="{link}" style=" border: 1px solid black; text-decoration: none; color: black; padding: 1px 40px; letter-spacing: 5px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('reset_password_email'); ?></a>
                <?php else: ?>
                    <a href="{link}" style=" border: 1px solid black; text-decoration: none; color: black; padding: 1px 40px; letter-spacing: 0px;font-weight: 600;font-size: 14px; background: none; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('reset_password_email'); ?></a>
                <?php endif; ?>
            </div>
    ...
    <footer style="padding: 0px 0px 150px 0px;">
        <div class="container" style="max-width: 800px; margin: auto;">
            <h2 style="text-align: center; border-bottom: 1.5px solid rgba(0, 0, 0, 0.5); padding-bottom: 25px; margin: 0px; font-size: 28px; font-weight: 400;font-family: 'Open Sans', sans-serif; font-style: italic;"><?= $this->lang->line('have_a_question'); ?>
