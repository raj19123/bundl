...
<body>
    ...
    <section class="order-section" style="padding: 50px 0px 70px 0px;">
        <div class="container" style="max-width: 800px; margin: auto">
            <h2 style="text-align: center; border-bottom: 2px solid rgba(0, 0, 0, 0.5); padding-bottom: 20px; margin: 0px; font-size: 32px; font-weight: 700; font-family: 'Open Sans', sans-serif;"><?= $this->lang->line('promo_code'); ?></h2>
